...
public class Game {
    ...
    {
        int MaxLimit=player.getTotalTiles()/10;
        if(MaxLimit==0)
            MaxLimit=1;
    ...
    private  void play()
    {
        ...
        if(hitenter.equals("")) {
            ...
            while (CurrentTileNumber != player.getTotalTiles() ) {
                ...
                while( !(Track[CurrentTileNumber-1]  instanceof  WhiteTile) || CurrentTileNumber!=1) {
//                    System.out.println(!(Track[CurrentTileNumber]  instanceof  WhiteTile) +"   "+ (CurrentTileNumber!=1));
                    ...
                    if (Track[CurrentTileNumber - 1] instanceof SnakeTile) {
                        ...
                        try {
                            ...
                            if (temp < 1) {
                                ...
                                System.out.println("Josh moved to Tile 1");
                                FreeStatus = false;
                                CurrentTileNumber = 1;
                            } else {
                                System.out.println("Josh moved to Tile " + temp);
                                CurrentTileNumber = temp;
                            }
                    ...
                    //If cant jump from a trampoline suppoose at 98 the loop will keep iterating there
                        ...
                        try {
                            ...
                            int temp = CurrentTileNumber + Track[CurrentTileNumber - 1].getMoveTiles();
                            if (temp > 100) {
                                System.out.println("Josh moved to Tile" + CurrentTileNumber + "as it can’t Jump further");
                            } else if (temp == 100) {
                                System.out.println("Josh moved to Tile 100");
                                CurrentTileNumber = 1;
                            } else {
                                System.out.println("Josh moved to Tile " + temp);
                                CurrentTileNumber = temp;
